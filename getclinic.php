...
<html>
    ...
    <body>
        ...
        <table>
            <?php
                $clinic= $_POST["clinic"];
                $query3 = 'SELECT * FROM DrWorksAt WHERE clinicName ="' . $clinic . '"';
                $result3=$connection->query($query3);


                echo "<h3>All Doctors at this site:</h3>";
        ...
        <table>
            <?php
                $clinic= $_POST["clinic"];
                $query3 = 'SELECT * FROM NurseWorksAt WHERE clinicName ="' . $clinic . '"';
                $result3=$connection->query($query3);


                echo "<h3>All Nurses at this site:</h3>";
                while ($row=$result3->fetch()) {
                    echo "<tr>
                        <td>".$row["ID"]."</td>";
                }
